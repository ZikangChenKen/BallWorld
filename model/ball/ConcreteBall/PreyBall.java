...
/**
 * Ball type that represents a prey entity.
 * @author swong
 *
 */
public class PreyBall extends ABall {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4992734719656949422L;
	 ...
	 */
	public PreyBall(Point location, int radius, Point velocity, Color color, IDimension dim,
