...
/**
 * The concrete friend ball class.
 */
public class FriendBall extends ABall{
	
	/**
	 * Serial version id.
	 */
	private static final long serialVersionUID = 9134726771890406725L;
	/**
	 *  The identifying host ID for this class.
	 */
	public static final IBallHostID ID = BallHostIDFactory.Singleton.makeID(FriendBall.class.getName());
	 ...
	 */
	public FriendBall(Point location, int radius, Point velocity, Color color, IDimension dim,
